      ...
      >
        ...
        >
          ...
          <div className="flex-1">
            <p className="text-accent-cyan text-xs font-mono uppercase mb-2">{t.whatWasDone}</p>
          ...
          <button
            type="button"
            className="mt-4 w-full py-2.5 border border-border text-text-muted rounded-xl text-sm hover:border-accent-cyan/40 hover:text-accent-cyan transition-colors"
            onClick={(e) => {
              e.stopPropagation();
              setIsFlipped(false);
            }}
