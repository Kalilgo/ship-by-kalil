...
function DockSeparator() {
  return (
    <div className="h-9 w-px shrink-0 self-center rounded-full bg-border/70 sm:h-10" aria-hidden />
  );
}
...
function WhatsAppDockIcon({ className = '' }: { className?: string }) {
  return (
    ...
    >
      <svg
        viewBox="0 0 24 24"
        className="h-[18px] w-[18px] shrink-0 text-white [transform:none] sm:h-5 sm:w-5"
        fill="currentColor"
      >
...
function LinkedInMark({ className = '' }: { className?: string }) {
  return (
    <span
      className={`flex size-[58%] min-w-[22px] items-center justify-center rounded-[11px] bg-[#0A66C2] shadow-inner ${className}`}
      aria-hidden
    >
...
function GitHubMark({ className = '' }: { className?: string }) {
  return (
    <span
      className={`flex size-[58%] min-w-[22px] items-center justify-center rounded-[11px] bg-[#24292f] shadow-inner ${className}`}
      aria-hidden
    >
      <svg viewBox="0 0 24 24" className="size-[62%] text-white" fill="currentColor">
