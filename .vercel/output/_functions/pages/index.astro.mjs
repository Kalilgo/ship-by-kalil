...
function SkillBar({ name, level, index }) {
  return /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "h-2 bg-surface-2 rounded-full overflow-hidden", children: /* @__PURE__ */ jsx(
      motion.div,
      {
        initial: { width: 0 },
...
function Skills() {
  ...
  return /* @__PURE__ */ jsx("section", { id: "skills", className: "py-20", children: /* @__PURE__ */ jsxs("div", { className: "max-w-6xl mx-auto px-6", children: [
    /* @__PURE__ */ jsxs("h2", { className: "text-3xl md:text-4xl font-bold font-heading text-text-primary mb-12", children: [
      "Skills & ",
      /* @__PURE__ */ jsx("span", { className: "text-accent-cyan", children: "Technologies" })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "flex flex-wrap gap-2 mb-8", children: skills.map((category, index) => /* @__PURE__ */ jsx(
      "button",
      {
    ...
    /* @__PURE__ */ jsx(AnimatePresence, { mode: "wait", children: /* @__PURE__ */ jsx(
      motion.div,
      {
        ...
        children: skills[activeTab].skills.map((skill, index) => /* @__PURE__ */ jsx(SkillBar, { ...skill, index }, skill.name))
      },
      activeTab
    ) })
  ] }) });
...
const projects = [
  {
    ...
    description: "Aplicación web para gestión de créditos y cobranzas para una financiera. Panel de control con métricas en tiempo real, gestión de clientes y generación de reportes.",
  ...
  },
  {
    ...
    description: "Plataforma web para listado y búsqueda de propiedades con filtros avanzados, galería de imágenes y formulario de contacto integrado.",
  ...
  },
  {
    ...
    description: "Backend RESTful para manejo de inventario con autenticación JWT, roles de usuario y documentación automática con Swagger.",
...
function Projects() {
  ...
  const filteredProjects = activeFilter === "Todos" ? projects : projects.filter((p) => p.tags.includes(activeFilter));
  return /* @__PURE__ */ jsx("section", { id: "proyectos", className: "py-20 bg-surface", children: /* @__PURE__ */ jsxs("div", { className: "max-w-6xl mx-auto px-6", children: [
    /* @__PURE__ */ jsxs("h2", { className: "text-3xl md:text-4xl font-bold font-heading text-text-primary mb-12", children: [
      "Proyectos ",
    ...
    /* @__PURE__ */ jsx(motion.div, { layout: true, className: "grid md:grid-cols-2 lg:grid-cols-3 gap-6", children: /* @__PURE__ */ jsx(AnimatePresence, { children: filteredProjects.map((project) => /* @__PURE__ */ jsxs(
      motion.article,
      {
        layout: true,
        ...
        children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-4", children: [
            /* @__PURE__ */ jsx("span", { className: "text-sm text-text-secondary", children: project.year }),
            /* @__PURE__ */ jsx(
              "span",
              {
          ...
          /* @__PURE__ */ jsx("h3", { className: "text-xl font-bold font-heading text-text-primary mb-2 group-hover:text-accent-cyan transition-colors", children: project.title }),
          /* @__PURE__ */ jsx("p", { className: "text-text-secondary text-sm mb-4 line-clamp-3", children: project.description }),
          /* @__PURE__ */ jsx("div", { className: "flex flex-wrap gap-2 mb-4", children: project.tags.map((tag) => /* @__PURE__ */ jsx(
            "span",
            {
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex gap-4", children: [
            /* @__PURE__ */ jsx("button", { className: "text-accent-cyan text-sm font-medium hover:underline", children: "Ver demo" }),
            /* @__PURE__ */ jsx("button", { className: "text-text-secondary text-sm font-medium hover:text-text-primary", children: "Ver código" })
          ] })
        ]
      },
      project.id
...
function Contact() {
  ...
  return /* @__PURE__ */ jsx("section", { id: "contacto", className: "py-20 bg-surface", children: /* @__PURE__ */ jsxs("div", { className: "max-w-6xl mx-auto px-6", children: [
    /* @__PURE__ */ jsxs("h2", { className: "text-3xl md:text-4xl font-bold font-heading text-text-primary mb-12", children: [
      "Contact",
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid md:grid-cols-2 gap-12", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("p", { className: "text-lg text-text-secondary mb-8", children: "¿Tenés un proyecto en mente? ¿Querés trabajar juntos? Escribime y te respondo lo antes posible." }),
      ...
      /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit(onSubmit), className: "space-y-4", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { htmlFor: "name", className: "block text-sm text-text-secondary mb-2", children: "Nombre" }),
          /* @__PURE__ */ jsx(
            "input",
            {
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { htmlFor: "email", className: "block text-sm text-text-secondary mb-2", children: "Email" }),
          /* @__PURE__ */ jsx(
            "input",
            {
              ...register("email", {
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { htmlFor: "subject", className: "block text-sm text-text-secondary mb-2", children: "Asunto" }),
          /* @__PURE__ */ jsx(
            "input",
            {
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { htmlFor: "message", className: "block text-sm text-text-secondary mb-2", children: "Mensaje" }),
          /* @__PURE__ */ jsx(
            "textarea",
            {
        ...
        /* @__PURE__ */ jsxs(
          "button",
          {
            ...
            children: [
              status === "loading" && /* @__PURE__ */ jsx(Loader2, { className: "w-5 h-5 animate-spin" }),
