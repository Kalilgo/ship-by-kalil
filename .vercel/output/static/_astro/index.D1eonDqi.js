import { M as $, j as y, u as z, P as b, a as S, b as A, L as D } from './proxy.Ce3DUqBB.js';
import { r as t } from './index.DYrVU9rO.js';
...
function T({ children: i, isPresent: l }) {
  const e = t.useId(),
    n = t.useRef(null),
    C = t.useRef({ width: 0, height: 0, top: 0, left: 0 }),
  ...
  return (
    ...
    y.jsx(K, { isPresent: l, childRef: n, sizeRef: C, children: t.cloneElement(i, { ref: n }) })
  );
}
const U = ({
  children: i,
  ...
  return (
    ...
    f === 'popLayout' && (i = y.jsx(T, { isPresent: e, children: i })),
    y.jsx(b.Provider, { value: c, children: i })
  );
};
function B() {
  return new Map();
