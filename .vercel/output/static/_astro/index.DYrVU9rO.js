...
function V() {
  ...
  function T(t, e, u) {
    var r = u.ref;
    return { $$typeof: a, type: t, key: e, ref: r !== void 0 ? r : null, props: u };
  }
  function K(t, e) {
  ...
  function _(t, e, u, r, o) {
    ...
    var p = r === '' ? '.' : r + ':';
    if (P(t))
      for (var c = 0; c < t.length; c++) ((r = t[c]), (s = p + C(r, c)), (i += _(r, e, u, s, o)));
    else if (((c = G(t)), typeof c == 'function'))
      for (t = c.call(t), c = 0; !(r = t.next()).done; )
        ((r = r.value), (s = p + C(r, c++)), (i += _(r, e, u, s, o)));
    else if (s === 'object') {
  ...
  return (
    ...
    (n.createElement = function (t, e, u) {
      ...
      if (t && t.defaultProps)
        for (r in ((i = t.defaultProps), i)) o[r] === void 0 && (o[r] = i[r]);
      return T(t, s, o);
    }),
    ...
    (n.startTransition = function (t) {
      ...
      try {
        var r = t(),
          o = f.S;
        (o !== null && o(u, r),
          typeof r == 'object' && r !== null && typeof r.then == 'function' && r.then(R, $));
      } catch (s) {
        $(s);
      } finally {
